    ...
    useEffect(() => {
        ...
        userData.projects
            ...
            .forEach((project) => {
                ...
                toDos += project.tasks.toDo.filter(
                    (task) => task.isDeleted === false
                ).length;
                inProgress += project.tasks.inProgress.filter(
                    (task) => task.isDeleted === false
                ).length;
                complete += project.tasks.complete.filter(
                    (task) => task.isDeleted === false
                ).length;
                setTotalToDos(toDos);
        ...
        <div className="dashboard">
            ...
            <div className="dashboard__grid">
                <button
                    ...
                    className="grid-button grid-button--large btn-transparent"
                >
                    ...
                    <div className="grid-button__info-container">
                        ...
                        <p className="grid-button__text">
                            ...
                            <strong>
                                {totalInProgress}{" "}
                                {totalInProgress === 1 ? "task" : "tasks"} in
                                progress
                            </strong>
                            .
                        </p>
                ...
                <button
                    onClick={() => openReports()}
                    className="grid-button grid-button--small btn-transparent"
                >
