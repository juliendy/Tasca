...
function ReportBox({
    ...
    return (
        <div
            className={`report-container ${getReportClass()} ${
                !reportIsOpen && "report-hidden"
            } ${isRead && "report-read"}`}
        >
            <button
                onClick={() => toggleOpenReport()}
                className="report-container__button btn-transparent"
            >
                <div className="report-container__button--top">
                    ...
                    <div className="report__details">
                        <p className="report__details--text">{`Click to ${
                            !reportIsOpen ? "Open" : "Close"
                        }`}</p>
                    </div>
                </div>
                <div className="report-container__button--bottom">
                    <div className="report-container__content">
                        {content && (
                            <p className="report-container__content--text">
                                {content}
                            </p>
                        )}
